# GROK.md — build-agent instructions for this folder

You (Grok Build) are the implementer for this agent. Claude acts as auditor/overseer. The source-of-truth spec and ledgers in this folder govern what to build; read them before changing code.
---
